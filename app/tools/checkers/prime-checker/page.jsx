          ...
          <div>
            ...
            <div className="flex gap-4">
              <Input
                ...
                className="flex-1"
              />
              <Button onClick={checkNumber} className="bg-green-600 hover:bg-green-700">Check</Button>
            </div>
          </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {nearestPrimes.before !== null && (
                      <div>
                        ...
                        <span className="ml-2 px-3 py-1 bg-green-50 dark:bg-green-900/20 rounded-full font-medium">
