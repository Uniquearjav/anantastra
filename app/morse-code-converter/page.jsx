...
export default function MorseCodeConverter() {
  ...
  const convertToMorse = () => {
    if (!textInput.trim()) {
      setMorseResult("Please enter text to convert");
      return;
    }
    
    const result = textInput.toUpperCase().split('').map(char => {
  ...
  const convertToText = () => {
    if (!morseInput.trim()) {
      setTextResult("Please enter morse code to convert");
      return;
    }
    
    // Split morse input by words (separated by '/') and characters (separated by spaces)
    const words = morseInput.trim().split('/').map(word => 
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 h-32 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                placeholder=".- -. .- -. - .- ... - .-. .-"
                className="w-full rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 h-32 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
              />
            </div>
